...
with col1:
    ...
    reg_no = st.text_input("Registration Number", placeholder="DIT001")
    ic = st.text_input("IC Number", placeholder="010101-01-1234")
...
st.markdown("---")
st.subheader("📊 Student Data Analysis Graph")
...
# Footer
st.markdown("---")
st.markdown("© 2026 BrightMind Tuition Centre")